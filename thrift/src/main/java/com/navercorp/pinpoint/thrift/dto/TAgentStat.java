...
public class TAgentStat implements org.apache.thrift.TBase<TAgentStat, TAgentStat._Fields>, java.io.Serializable, Cloneable, Comparable<TAgentStat> {
  ...
  private static final org.apache.thrift.protocol.TField THREADS_FIELD_DESC = new org.apache.thrift.protocol.TField("threads", org.apache.thrift.protocol.TType.STRUCT, (short)40);
  ...
  private TJvmThreads threads; // optional
  ...
  private static final _Fields optionals[] = {_Fields.AGENT_ID,_Fields.START_TIMESTAMP,_Fields.TIMESTAMP,_Fields.COLLECT_INTERVAL,_Fields.GC,_Fields.CPU_LOAD,_Fields.TRANSACTION,_Fields.THREADS,_Fields.METADATA};
  ...
  static {
    ...
    tmpMap.put(_Fields.THREADS, new org.apache.thrift.meta_data.FieldMetaData("threads", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TJvmThreads.class)));
  ...
  public TAgentStat(TAgentStat other) {
    ...
    if (other.isSetThreads()) {
      this.threads = new TJvmThreads(other.threads);
    }
  ...
  public TJvmThreads getThreads() {
    return this.threads;
  }

  public void setThreads(TJvmThreads threads) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TAgentStat struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 40: // THREADS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.threads = new TJvmThreads();
              struct.threads.read(iprot);
